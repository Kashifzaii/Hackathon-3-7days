...
const client = createClient({
    projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID="wa1piapr",
    dataset: process.env.NEXT_PUBLIC_SANITY_DATASET="production",
    useCdn: false,
    token: process.env.SANITY_API_TOKEN="sk6FqZSds4spGwZ3TxtPh8HJe1XDN7lLlIkEdoSMTDLrvJi0Ua5bbqgo3Pu2wn0PReeXR9Q6CEj8oEpEg9xY1XjhX0m4pW6Zr8ym5EkXB1Mrrsx6AP62XrPJQ2tL2PTzyFndeS8qSVtgPcCP5RerqQlpOEQqiWUwllZn0012oA5e6ixZ0Ysk",
